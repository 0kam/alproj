from src.alproj.pointcloud import create_db, crop
...
# crop_pointcloud
conn = sqlite3.connect("/home/okamoto/alproj/devel_data/pc.db")
params = {"x":732731,"y":4051171, "z":2458, "fov":70, "pan":100, "tilt":0, "roll":90,\
     "a1":1, "a2":1, "k1":0.05, "k2":0, "k3":0, "k4":0, "k5":0.1, "k6":0, \
         "p1":0, "p2":0.1, "s1":-0.1, "s2":0, "s3":0, "s4":0, \
